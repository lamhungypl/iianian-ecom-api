...
let CountryController = class CountryController {
  ...
  countryList(limit, offset, keyword = '', count, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const countryListCount = yield this.countryService.count(options);
        const successResponse = {
          status: 1,
  ...
  deleteCountry(id, response, request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const deleteCountry = yield this.countryService.delete(country.countryId);
      if (deleteCountry) {
        const successResponse = {
          status: 1,
          message: 'Successfully deleted country.',
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      createCountryRequest_1.CreateCountry,
      Object,
    ]),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      updateCountryRequest_1.UpdateCountry,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
  ],
