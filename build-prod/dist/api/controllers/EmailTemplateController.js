...
let EmailTemplateController = class EmailTemplateController {
  ...
  addEmailTemplate(emailTemplateParam, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const emailTemplateSave = yield this.emailTemplateService.create(
        emailTemplate
      );
  ...
  emailTemplateList(limit, offset, keyword, count, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const emailTemplateCount = yield this.emailTemplateService.count(
          options
        );
        const successResponse = {
          status: 1,
      ...
      const emailTemplateList = yield this.emailTemplateService.list(options);
  ...
  updateEmailTemplate(id, emailTemplateParam, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      emailTemplate.content = emailTemplateParam.content;
      emailTemplate.isActive = emailTemplateParam.status;
      const templateSave = yield this.emailTemplateService.create(
        emailTemplate
      );
  ...
  deleteEmailTemplate(id, response, request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const deleteEmailTemplate = yield this.emailTemplateService.delete(
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      createEmailTemplateRequest_1.CreateEmailTemplate,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
  ],
  EmailTemplateController.prototype,
  'addEmailTemplate',
  null
);
tslib_1.__decorate(
