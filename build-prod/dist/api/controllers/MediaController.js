...
let MediaController = class MediaController {
  ...
  CreateFolder(folderNameValidation, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      let val;
      if (env_1.env.imageserver === 's3') {
        val = yield this.s3Service.createFolder(
          folderNameValidation.folderName
        );
      } else {
        val = yield this.imageService.createFolder(
          folderNameValidation.folderName
        );
      }
      if (val) {
  ...
  DeleteFolder(folderNameValidation, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      //console.log('working');
      //console.log('S3 folderName:- ' + folderNameValidation.folderName);
      const val = yield this.s3Service.deleteFolder(
        folderNameValidation.folderName
      );
      //console.log(val);
      if (val) {
  ...
  uploadFile(fileNameRequest, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      let val;
      if (env_1.env.imageserver === 's3') {
        val = yield this.s3Service.imageUpload(
          path === '' ? name : path + name,
          base64Data,
          type
        );
      } else {
        val = yield this.imageService.imageUpload(
          path === '' ? name : path + name,
          base64Data
        );
      }
  ...
  image_resize(width, height, name, path, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (ext[1] === 'jpg' || ext[1] === 'jpeg' || ext[1] === 'png') {
        let val;
        if (env_1.env.imageserver === 's3') {
          val = yield this.s3Service.resizeImage(
            imgName,
            imgPath,
            widthString,
            heightString
          ...
          val = yield this.imageService.resizeImage(
            imgName,
            imgPath,
            widthString,
            heightString
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__param(0, routing_controllers_1.QueryParam('folderName')),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      createFolderNameRequest_1.FolderNameRequest,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
...
tslib_1.__decorate(
  [
    ...
    routing_controllers_1.Authorized(),
    tslib_1.__param(0, routing_controllers_1.QueryParam('fileName')),
    tslib_1.__param(1, routing_controllers_1.Req()),
    tslib_1.__param(2, routing_controllers_1.Res()),
    tslib_1.__metadata('design:type', Function),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      createFileNameRequest_1.FileNameRequest,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__param(0, routing_controllers_1.QueryParam('width')),
    tslib_1.__param(1, routing_controllers_1.QueryParam('height')),
    tslib_1.__param(2, routing_controllers_1.QueryParam('name')),
    tslib_1.__param(3, routing_controllers_1.QueryParam('path')),
