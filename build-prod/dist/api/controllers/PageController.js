...
let PageController = class PageController {
   ...
   * HTTP/1.1 500 Internal Server Error
   */
  pageList(limit, offset, keyword, count, status, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      const options = Object.assign(
        ...
        ),
        {
          ...
          where: pickBy_1.default(
            {
              title: (keyword && typeorm_1.Like(`%${keyword}%`)) || undefined,
              isActive: (status && lodash_1.parseInt(status)) || 0,
            },
            value => value != null
          ),
        }
      ...
      if (count) {
        const pageListCount = yield this.pageService.count(options);
        const successResponse = {
          status: 1,
  ...
  deletePage(id, response, request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const deletePage = yield this.pageService.delete(page.pageId);
      if (deletePage) {
        const successResponse = {
          status: 1,
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      createPageRequest_1.CreatePage,
      Object,
    ]),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      updatePageRequest_1.UpdatePage,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
  ],
