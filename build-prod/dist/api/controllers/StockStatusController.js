...
let StockStatusController = class StockStatusController {
  ...
  createStockStatus(stockStatusParam, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const StockStatusSave = yield this.stockStatusService.create(
        newStockStatus
      );
  ...
  stockStatusList(limit, offset, keyword, count, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const stockStatusCount = yield this.stockStatusService.count(options);
        const successResponse = {
          status: 1,
      ...
      const stockStatusList = yield this.stockStatusService.list(options);
      if (stockStatusList) {
        const successResponse = {
          status: 1,
          message: 'Successfully got all stockStatus List',
  ...
  deleteStockStatus(id, response, request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const deleteStockStatus = yield this.stockStatusService.delete(
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      createStockStatusRequest_1.CreateStockStatus,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
  ],
  StockStatusController.prototype,
  'createStockStatus',
  null
);
tslib_1.__decorate(
...
StockStatusController = tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      stockStatusService_1.StockStatusService,
    ]),
  ],
