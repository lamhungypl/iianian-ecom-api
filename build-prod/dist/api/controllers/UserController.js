...
let UserController = class UserController {
  ...
  findAll(limit, offset, keyword = '', count, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      const options = Object.assign(
        ...
        ),
        {
          ...
          where: lodash_1.pickBy(
            {
              firstName:
                (keyword && typeorm_1.Like(`%${keyword}%`)) || undefined,
            },
            value => value != null
          ),
          relations: ['usergroup'],
      ...
      if (count) {
        const usersCount = yield this.userService.count(options);
        const successResponse = {
          status: 1,
          data: usersCount,
      ...
      const users = yield this.userService.list(options);
      const successResponse = {
        status: 1,
        data: users,
        message: 'Successfully get All user List',
  ...
  createUser(createParam, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const userGroupExistRecord = yield this.userGroupService.list(options);
      ...
      const newUserPassword = yield User_1.User.hashPassword(
  ...
  forgotPassword(forgotPassword, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const emailContent = yield this.emailTemplateService.findOneById(2);
      const message = emailContent.content
        .replace('{name}', user.firstName)
        .replace('{xxxxxx}', tempPassword);
      const sendMailRes = mail_services_1.MAILService.passwordForgotMail(
        message,
        user.email,
  ...
  changePassword(changePasswordParam, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (
        yield User_1.User.comparePassword(user, changePasswordParam.oldPassword)
      ) {
        const val = yield User_1.User.comparePassword(
          user,
        ...
        user.password = yield User_1.User.hashPassword(
          changePasswordParam.newPassword
        );
  ...
  logout(request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const deleteToken = yield this.accessTokenService.delete(user.id);
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      createUserRequest_1.CreateUser,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
  ],
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      Number,
      UpdateUserRequest_1.UpdateUserRequest,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
  ],
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      forgotPasswordRequest_1.ForgotPassword,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
  ],
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      ChangePasswordRequest_1.ChangePassword,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      editProfileRequest_1.EditProfileRequest,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
