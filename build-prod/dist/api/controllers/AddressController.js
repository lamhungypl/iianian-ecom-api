...
let AddressController = class AddressController {
  ...
  addressList(limit, offset, count, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const addressListCount = yield this.addressService.count(options);
        const successResponse = {
          status: 1,
      ...
      const addressList = yield this.addressService.list(options);
      if (addressList) {
        const successResponse = {
          status: 1,
          message: 'Successfully got complete address list.',
  ...
  deleteAddress(id, response, request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const deleteAddress = yield this.addressService.delete(address.addressId);
      if (deleteAddress === 1) {
        const successResponse = {
          status: 1,
          message: 'Successfully deleted address',
  ...
  getAddress(limit, offset, count, id, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const customerAddressCount = yield this.addressService.count(options);
        const successResponse = {
          status: 1,
      ...
      const customerAddress = yield this.addressService.list(options);
      const successResponse = {
        status: 1,
        message: 'Successfully Get the customer Address',
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      CreateAddressRequest_1.CreateAddress,
      Object,
    ]),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__param(1, routing_controllers_1.QueryParam('offset')),
    tslib_1.__param(2, routing_controllers_1.QueryParam('count')),
    tslib_1.__param(3, routing_controllers_1.Param('id')),
