...
let CategoryController = class CategoryController {
  ...
  addCategory(category, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const getAllPath = yield this.categoryPathService.list({
  ...
  updateCategory(category, response, request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const deleteCategory = yield this.categoryPathService.list({
  ...
  deleteCategory(category, response, request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      const categoryTarget = yield this.categoryService.findOne({
        where: {
          categoryId: category.categoryId,
        },
      });
      ...
      const categoryPath = yield this.categoryPathService.list({
        where: { categoryId: category.categoryId },
      });
      for (const path of categoryPath) {
        yield this.categoryPathService.delete(path.categoryPathId);
      }
      const deleteCategory = yield this.categoryService.delete(
  ...
  categorylist(limit, offset, keyword, sortOrder, count, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const categoryCount = yield this.categoryService.count(options);
        const successResponse = {
          status: 1,
          message: 'successfully got the complete category list. ',
          data: categoryCount,
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      addCategoryRequest_1.AddCategory,
      Object,
    ]),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      updateCategoryRequest_1.UpdateCategoryRequest,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      deleteCategoryRequest_1.DeleteCategoryRequest,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
