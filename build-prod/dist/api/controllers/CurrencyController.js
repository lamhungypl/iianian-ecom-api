...
let CurrencyController = class CurrencyController {
  ...
  currencyList(limit, offset, keyword, count, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const currencyCount = yield this.currencyService.count(options);
        const successResponse = {
          status: 1,
      ...
      const currencyList = yield this.currencyService.list(options);
      if (currencyList) {
        const successResponse = {
          status: 1,
          message: 'Successfully got the complete currency list.',
  ...
  deleteCurrency(id, response, request) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const deleteCurrency = yield this.currencyService.delete(
        currency.currencyId
      );
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      createCurrencyRequest_1.CreateCurrency,
      Object,
    ]),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      updateCurrenyRequest_1.UpdateCurrency,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
  ],
