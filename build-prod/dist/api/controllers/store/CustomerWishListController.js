...
let CustomerController = class CustomerController {
  ...
  wishlistProductlist(limit, offset, count, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const wishlistCount = yield this.customerWishlistService.count(options);
        const Response = {
          status: 1,
      ...
      const wishlistData = yield this.customerWishlistService.list(options);
      const promises = wishlistData.map(results =>
        tslib_1.__awaiter(this, void 0, void 0, function* () {
          ...
          const temp = Object.assign(Object.assign({}, productData), {
            pricerefer: '',
            flag: '',
          });
