...
let CustomerController = class CustomerController {
  ...
  register(registerParam, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      newUser.password = yield Customer_1.Customer.hashPassword(
      ...
      if (registerParam.password === registerParam.confirmPassword) {
        ...
        const emailContent = yield this.emailTemplateService.findOneById(1);
        const message = emailContent.content.replace(
          '{name}',
          resultData.firstName
        );
        const sendMailRes = mail_services_1.MAILService.registerMail(
          message,
          resultData.email,
  ...
  forgotPassword(forgotparam, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      resultData.password = yield Customer_1.Customer.hashPassword(
        tempPassword
      );
      const updateUserData = yield this.customerService.update(
        resultData.id,
        resultData
      );
  ...
  login(loginParam, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (
        yield Customer_1.Customer.comparePassword(
          resultData,
          loginParam.password
        )
      ) {
  ...
  changePassword(changePasswordParam, request, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        const val = yield Customer_1.Customer.comparePassword(
          resultData,
  ...
  LogList(limit, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const promise = loginLogList.map(result =>
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      customerRegisterRequest_1.CustomerRegisterRequest,
      Object,
      Object,
    ]),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      customerLoginRequest_1.CustomerLogin,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      customerEditProfileRequest_1.CustomerEditProfileRequest,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      customerOauthLoginRequest_1.CustomerOauthLogin,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
