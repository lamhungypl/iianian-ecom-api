...
let RoleController = class RoleController {
  ...
  createRole(createRoleParam, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      const userGroupSaveResponse = yield this.userGroupService.create(
        newRoleParams
      );
  ...
  updateRole(id, createRoleParam, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      newRoleParams.name = createRoleParam.name;
      newRoleParams.isActive = createRoleParam.status;
      const userGroupSaveResponse = yield this.userGroupService.update(
        id,
        newRoleParams
      );
      if (userGroupSaveResponse) {
  ...
  roleList(limit, offset, keyword = '', count, response) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      if (count) {
        const roleListCount = yield this.userGroupService.count(options);
        const successResponse = {
          status: 1,
      ...
      const roleList = yield this.userGroupService.list(options);
      const successResponse = {
        status: 1,
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:paramtypes', [
      createRoleRequest_1.CreateRole,
      Object,
    ]),
...
tslib_1.__decorate(
  [
    ...
    tslib_1.__metadata('design:type', Function),
    tslib_1.__metadata('design:paramtypes', [
      deleteRoleRequest_1.DeleteRoleRequest,
      Object,
      Object,
    ]),
    tslib_1.__metadata('design:returntype', Promise),
