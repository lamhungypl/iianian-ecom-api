...
tslib_1.__decorate(
  [
    typeorm_1.ManyToOne(
      type => ProductModel_1.Product,
      product => product.productToCategory
    ),
...
tslib_1.__decorate(
  [
    typeorm_1.ManyToOne(
      type => categoryModel_1.Category,
      category => category.productToCategory
    ),
