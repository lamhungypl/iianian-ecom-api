...
tslib_1.__decorate(
  [typeorm_1.Column({ name: 'ip' }), tslib_1.__metadata('design:type', String)],
  Order.prototype,
  'ip',
  void 0
);
...
tslib_1.__decorate(
  [
    typeorm_1.ManyToOne(
      type => orderStatus_1.OrderStatus,
      orderStatus => orderStatus.statusOfOrder
    ),
...
Order = tslib_1.__decorate([typeorm_1.Entity('order')], Order);
exports.Order = Order;
