...
const express_basic_auth_1 = tslib_1.__importDefault(
  require('express-basic-auth')
);
const express_status_monitor_1 = tslib_1.__importDefault(
...
exports.monitorLoader = settings => {
  if (settings && env_1.env.monitor.enabled) {
    ...
    expressApp.get(
      env_1.env.monitor.route,
      env_1.env.monitor.username
        ? express_basic_auth_1.default({
            users: {
