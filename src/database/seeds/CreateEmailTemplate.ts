...
export class CreateEmailTemplate implements Seed {
  public async seed(
    ...
    const customerOrderData =
      "Dear {name},        </td>    </tr>    <tr>        <td dir='ltr' style='padding:0 0px;color:#078e05;font-weight:400;text-align:left;font-size:16px;line-height:1.5rem;padding-top:10px;font-family: 'Roboto', sans-serif;' valign='top'> Order successfully placed.        </td>    </tr>   " +
    ...
    const adminNotifyData =
      "Dear Mr.Admin,        </td>    </tr>    <tr>        <td dir='ltr' style='padding:0 0px;color:#078e05;font-weight:400;text-align:left;font-size:16px;line-height:1.5rem;padding-top:10px;font-family: 'Roboto', sans-serif;' valign='top'> A new order has been placed.         </td>    </tr>    <tr>    " +
