  ...
  api: [
    {
      ...
      group:
        '/Volumes/Edu/workplaces/nodeJS/Ecommerce/Project/api/src/public/apidoc/main.js',
      groupTitle:
        '/Volumes/Edu/workplaces/nodeJS/Ecommerce/Project/api/src/public/apidoc/main.js',
      name: '',
    },
    {
      ...
      group:
        '/Volumes/Edu/workplaces/nodeJS/Ecommerce/Project/api/src/public/main.js',
      groupTitle:
        '/Volumes/Edu/workplaces/nodeJS/Ecommerce/Project/api/src/public/main.js',
      name: '',
    },
    ...
    },
    {
      ...
      version: '0.0.0',
      filename: 'src/api/controllers/_UserController.ts',
      groupTitle: 'Authentication',
      name: 'DeleteApiAuthDeleteUserId',
    },
    {
    ...
    },
    {
      ...
      sampleRequest: [
        {
          url:
            'http://localhost:8000/api/email-template/delete-email-template/:id',
        },
      ],
      error: {
        examples: [
    ...
    },
    {
      ...
      sampleRequest: [
        {
          url:
            'http://localhost:8000/api/email-template/update-email-template/:id',
        },
      ],
      error: {
        examples: [
    ...
    },
    {
      ...
      sampleRequest: [
        {
          url:
            'http://localhost:8000/api/product-store/update-featureproduct/:id',
        },
      ],
      error: {
        examples: [
