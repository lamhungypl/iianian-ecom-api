...
export class CustomerOrderController {
  ...
  @Authorized('customer')
  public async customerCheckout(
    @Body({ validate: true }) checkoutParam: CustomerCheckoutRequest,
    @Res() response: any,
    @Req() request: any
  ): Promise<any> {
    ...
    const resultData = await this.orderService.update(
      orderData.orderId,
      newOrder
    );
    ...
    const sendMailRes = MAILService.customerOrderMail(
      customerMessage,
      orderData,
