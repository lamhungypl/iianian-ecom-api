...
export class ManufacturerController {
  ...
  public async createManufacturer(
    @Body({ validate: true }) manufacturer: CreateManufacturer,
    @Req() request: any,
    @Res() response: any
  ): Promise<any> {
  ...
  @Authorized()
  public async deleteManufacturer(
    @Body({ validate: true }) manufacturer: DeleteManufacturer,
    @Res() response: any,
    @Req() request: any
    ...
    const deleteManufacturer: any = await this.manufacturerService.delete(
  ...
  public async updateManufacturer(
    @Body({ validate: true }) manufacturerParam: UpdateManufacturer,
    @Res() response: any,
    @Req() request: any
  ): Promise<any> {
    ...
    const manufacturerSave = await this.manufacturerService.create(
      manufacturer
    );
