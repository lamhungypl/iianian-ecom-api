...
module.exports = {
  scripts: {
     ...
     */
    staging: {
      script: 'cross-env NODE_ENV=staging node dist/app.js',
      description: 'Starts the builded app',
    },
    /**
     * Starts the builded app from the dist directory.
     ...
     */
    dbseed: {
      script: series('npm install', 'nps db.seed'),
    ...
    copy: {
      default: {
        script: series(`nps copy.public`, `nps copy.apidoc`),
        hiddenFromHelp: true,
      },
      apidoc: {
        script: copyDir('./src/public/', './dist/public/'),
        hiddenFromHelp: true,
      },
      public: {
